...
public class UserVO {
    ...
    private String userType;       // 사용자구분 (예: 'C' - 일반사용자, 'B' - 기업)
    ...
    private String statusYn;      // 활퇴여부 ('Y' - 활성, 'N' - 탈퇴)
    private Date expireDays;      // 구독만료일까지
    private String address;       // 주소
    private String hobby;         // 취미/특기
    private String notes;         // 특이사항
    private int userNo;          // 회원일련번호 (PK)
    private String emailVerifyToken;  // 이메일 인증 토큰
    private String emailVerified;     // 이메일 인증 여부 ('Y' - 인증완료, 'N' - 미인증)
    private Date tokenExpireTime;     // 토큰 만료 시간
    ...
    public UserVO(String loginId, String userType, String userName, String password,
                  ...
                  String address, String hobby, String notes, int userNo,
                  String emailVerifyToken, String emailVerified, Date tokenExpireTime,
                  String resetToken) {
