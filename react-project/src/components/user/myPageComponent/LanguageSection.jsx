        ...
        if (isConfirm) {
            ...
            await axios
                ...
                .then((res) => {
                    ...
                    if (onListChange) {
                        const updatedLanguageSkilList = languageSkillList.filter(
                            (lang) => lang.language !== languageToDelete
                        );
    ...
    return (
        <div className="careerInfoSection">
            <div className="careerInfoHeader">
                ...
                <p
                    className={`plusFunction ${isAddButtonDisabled ? 'disabled-button' : ''}`}
