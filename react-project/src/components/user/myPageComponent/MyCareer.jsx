...
const MyCareer = () => {
  ...
  //   useEffect(() => {
  //     const storedUserNo = sessionStorage.getItem('userNo');
  //     if (storedUserNo) {
  //       setUserNo(Number(storedUserNo)); // String으로 저장되므로 숫자로 변환
  //       console.log('sessionStorage에서 불러온 userNo:', storedUserNo);
  //     } else {
